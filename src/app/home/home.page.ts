...
export class HomePage {
  ...
  public lanches = [
    ...
    { codigo: 3, categoria: 3, preco: 'R$ 30,90', nome: 'Pizza Portuguesa', descricao : 'Ingredientes: Molho de tomate, Presunto, Muçarela, Cebola cortadas em rodelas, Tomates cortados em rodelas, Ovos cozidos picados, Orégano.', visibled: false, imagem: ['pizzaportuguesa1.jpg', 'pizzaportuguesa2.jpg']}
